            ...
            <div class="col-lg-9">
                <div class="home-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light">
                    <div class="home-slide">
                        <div class="owl-lazy slide-bg" data-src="assets/images/slider/Bannx1.jpeg"></div>
                        ...
                        <div class="product-default  ">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <form name="formulario" action=""   style="margin:0 !important">
                                        @csrf
                                           <div class="product-single-qty">
                                          <input class="horizontal-quantity form-control"   id="cantidad" name="cantidad" type="text"></div>
                                      

                                    <input type="hidden" value="{{$item->id}}"  id="idproducto" name="idproducto">
                                    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                                    <button class="btn btn-outline-primary btn-rounded waves-effect"  onclick="enviarDatos('{{$item->id}}',this.cantidad.value); return false"  type="submit"><i class="icon-bag"></i>Agregarx</button>
